...
ggsave('LDA_real_data_1.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('MaxLogRatio_real_data(onlyAcc).png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('LDA_means.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('Max_means.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
