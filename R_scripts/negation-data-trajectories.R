...
ggplot(normalized_positions.plot, aes(x=X.Position, y=Y.Position, color=Polarity, group=grp)) + 
  ...
  theme(legend.position = "none") 
ggsave('negation-data-trajectory.png', plot = last_plot(), scale = 1, dpi = 300, width=10, path='R_scripts/graphs/negation_data')
...
ggsave('negation-data-Xposition-subject.png', plot = last_plot(), scale = 1, dpi = 300, width=7, path='R_scripts/graphs/negation_data')
...
ggsave('negation-data-mean-Xposition.png', plot = last_plot(), scale = 1, dpi = 300, width=6, path='R_scripts/graphs/negation_data')
