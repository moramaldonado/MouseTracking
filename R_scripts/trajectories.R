...
ggsave('calibration_XPosition.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('calibration_mean_XPosition.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('calibration_mean_trajectory.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
