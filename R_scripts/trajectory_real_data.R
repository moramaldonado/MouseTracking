...
ggsave('negation-data-trajectory.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggplot(normalized_positions.plot, aes(x=Time.Step, y=X.Position, color=Polarity, group=grp)) +
  ...
  facet_grid(lda_measure_cut~Expected_response) 
ggsave('negation-data-Xposition.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('negation-data-Xposition-subject.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('negation-data-mean-Xposition.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('negation-data-subject-trajectory.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('negation-data-mean-trajectory.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
...
ggsave('negation-data-mean-sentences.png', plot = last_plot(), scale = 1, dpi = 300, path='R_scripts/graphs')
