...
par(mfrow=c(2,2))
hist(subset(mydata.true, predictor==1)$LogMaxDeviation.scale, main='Aff,MD')
hist(subset(mydata.true, predictor==-1)$LogMaxDeviation.scale, main='Neg,MD')
hist(subset(mydata.true, predictor==1)$lda_measure.scale, main='Aff,LDA')
...
par(mfrow=c(2,2))
hist(subset(mydata.validation, predictor==1)$LogMaxDeviation.scale, main='Straight,MD')
hist(subset(mydata.validation, predictor==-1)$LogMaxDeviation.scale, main='Deviated,MD')
hist(subset(mydata.validation, predictor==1)$lda_measure.scale, main='Straight,LDA')
