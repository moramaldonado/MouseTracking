            ...
            for t in range(len(all_trials[i])):
                    ...
                    writer.writerow((str(i), all_trials[i][t]['type'], all_trials[i][t]['adjective'], all_trials[i][t]['polarity'],
                                      all_trials[i][t]['expected_response'],
                                        all_trials[i][t]['value'], all_trials[i][t]['accuracy'], all_trials[i][t]['RT'], all_trials[i][t]['maxDeviation'][0], all_trials[i][t]['maxDeviation'][1],all_trials[i][t]['maxDeviation'][2], all_trials[i][t]['maxDeviationBorder'][0], all_trials[i][t]['maxDeviationBorder'][1],all_trials[i][t]['maxDeviationBorder'][2], all_trials[i][t]['max_ratio'][0],all_trials[i][t]['max_ratio_log'][0],all_trials[i][t]['max_ratio'][1],all_trials[i][t]['max_ratio'][2],all_trials[i][t]['max_difference'][0],all_trials[i][t]['max_difference'][1],all_trials[i][t]['max_difference'][2], all_trials[i][t]['max_smooth_acceleration'][0],all_trials[i][t]['max_smooth_acceleration'][1],all_trials[i][t]['max_smooth_acceleration'][2], all_trials[i][t]['integral_ratio_on_max_smooth_acceleration'],all_trials[i][t]['integral_ratio_log_on_max_smooth_acceleration'],all_trials[i][t]['integral_ratio_log_on_fin'],all_trials[i][t]['integral_difference_on_max_smooth_acceleration'],all_trials[i][t]['integral_X_on_max_smooth_acceleration'],all_trials[i][t]['integral_X_on_fin'],all_trials[i][t]['local_maxima'],len(all_trials[i][t]['local_maxima']),all_trials[i][t]['delay'],all_trials[i][t]['ratio_log_in_max_smooth_acceleration']))
