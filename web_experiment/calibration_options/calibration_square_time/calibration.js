...
*/
            ...
            switch (order_calibration[exp_pointer].substring(0,3)) {
                case 'RG1':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('red', width, height);}, t1);
                    setTimeout(function() {setColor('blue', width, height);}, t21);
                ...
                case 'RG2':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('red', width, height);}, t1);
                    setTimeout(function() {setColor('blue', width, height);}, t22);
                    console.log(exp_pointer);
                    break;
                ...
                case 'RG3':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('red', width, height);}, t1);
                    setTimeout(function() {setColor('blue', width, height);}, t23);
                    console.log(exp_pointer);
                    break;

                case 'GR1':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('blue', width, height);}, t1);
                    setTimeout(function() {setColor('red', width, height);}, t21);
                    console.log(exp_pointer);
                    break;
                ...
                case 'GR2':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('blue', width, height);}, t1);
                    setTimeout(function() {setColor('red', width, height);}, t22);
                    console.log(exp_pointer);
                    break;
                ...
                case 'GR3':
                    setColor('white', width, height);
                    setTimeout(function() {setColor('blue', width, height);}, t1);
                    setTimeout(function() {setColor('red', width, height);}, t23);
                    console.log(exp_pointer);
                    break;
    ...
    function setColor(color, width, height)
    {   ctx.fillStyle = color;
        ctx.strokeStyle ='black';
        ctx.lineWidth = 2;
        ctx.beginPath();
